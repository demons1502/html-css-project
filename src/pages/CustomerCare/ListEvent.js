...
export default function ListEvent() {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: 'date',
      render: (record) => {
        return <span>{moment(record.date).format(FORMAT_DATE)}</span>;
      },
    },
    {
      ...
      render: (record) => {
        return (
          <div className='btn-table'>
            <Button
              className='btn-table__btn m-r-10'
            ...
            >
              <Button
                className='btn-table__btn flex-end'
    ...
    <>
      ...
      <ModalCommon
        ...
        title={
          Object.keys(detailData).length > 0
            ? t('customer care.edit event title')
            : t('customer care.add event title')
        }
        width={770}
        content={
          <AddEventContent
      ...
      <ModalCommon
        ...
        content={
          <SendEmailContent
            eventId={eventId}
            setVisibleModalEmail={setVisibleModalEmail}
          />
        }
      />
      <ModalCommon
        ...
        content={
          <SendSmsContent
            eventId={eventId}
            setVisibleModalSms={setVisibleModalSms}
          />
        }
      />
    </>
