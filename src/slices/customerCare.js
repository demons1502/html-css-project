...
export const createData = createAsyncThunk('customerCare/create', async (payload, { rejectWithValue, getState }) => {
  try {
...
export const updateData = createAsyncThunk('customerCare/update', async ({ id, data }, { rejectWithValue }) => {
  try {
...
export const deleteData = createAsyncThunk('customerCare/delete', async (id, { rejectWithValue }) => {
  try {
